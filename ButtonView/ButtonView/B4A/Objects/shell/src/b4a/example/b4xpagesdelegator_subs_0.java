...
try {
		Debug.PushSubsStack("Activity_ActionBarHomeClick (b4xpagesdelegator) ","b4xpagesdelegator",15,__ref.getField(false, "ba"),__ref,35);
...
try {
		Debug.PushSubsStack("Activity_KeyPress (b4xpagesdelegator) ","b4xpagesdelegator",15,__ref.getField(false, "ba"),__ref,27);
...
try {
		Debug.PushSubsStack("Activity_Pause (b4xpagesdelegator) ","b4xpagesdelegator",15,__ref.getField(false, "ba"),__ref,52);
...
try {
		Debug.PushSubsStack("Activity_PermissionResult (b4xpagesdelegator) ","b4xpagesdelegator",15,__ref.getField(false, "ba"),__ref,31);
...
try {
		Debug.PushSubsStack("Activity_Resume (b4xpagesdelegator) ","b4xpagesdelegator",15,__ref.getField(false, "ba"),__ref,48);
...
try {
		Debug.PushSubsStack("Create_Menu (b4xpagesdelegator) ","b4xpagesdelegator",15,__ref.getField(false, "ba"),__ref,39);
...
try {
		Debug.PushSubsStack("Initialize (b4xpagesdelegator) ","b4xpagesdelegator",15,__ref.getField(false, "ba"),__ref,4);
...
try {
		Debug.PushSubsStack("MainForm_Resize (b4xpagesdelegator) ","b4xpagesdelegator",15,__ref.getField(false, "ba"),__ref,44);
