...
try {
		Debug.PushSubsStack("Base_Resize (b4xloadingindicator) ","b4xloadingindicator",28,__ref.getField(false, "ba"),__ref,37);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xloadingindicator.class, "_mainloop" /*void*/ );
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xloadingindicator) ","b4xloadingindicator",28,__ref.getField(false, "ba"),__ref,26);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.b4xloadingindicator.class, "_setstyle" /*RemoteObject*/ ,(Object)(_style));
...
try {
		Debug.PushSubsStack("Draw_Arc1 (b4xloadingindicator) ","b4xloadingindicator",28,__ref.getField(false, "ba"),__ref,112);
...
try {
		Debug.PushSubsStack("Draw_Arc2 (b4xloadingindicator) ","b4xloadingindicator",28,__ref.getField(false, "ba"),__ref,125);
...
try {
		Debug.PushSubsStack("Draw_FiveLines1 (b4xloadingindicator) ","b4xloadingindicator",28,__ref.getField(false, "ba"),__ref,102);
...
try {
		Debug.PushSubsStack("Draw_PacMan (b4xloadingindicator) ","b4xloadingindicator",28,__ref.getField(false, "ba"),__ref,138);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("DrawCircle",(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"getTargetRect").runMethod(true,"getWidth"),_dotr,_progress,(RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"getTargetRect").runMethod(true,"getCenterX"),b4xloadingindicator.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10)))}, "-",1, 0))}, "--*",2, 0))),(Object)(__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"getTargetRect").runMethod(true,"getCenterY")),(Object)(BA.numberCast(float.class, _dotr)),(Object)(__ref.runClassMethod (b4a.example.b4xloadingindicator.class, "_setalpha" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_indicatorcolor" /*RemoteObject*/ )),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(255),RemoteObject.createImmutable(200),_progress}, "-*",1, 0))))),(Object)(b4xloadingindicator.__c.getField(true,"True")),(Object)(BA.numberCast(float.class, 0)));
...
try {
		Debug.PushSubsStack("Draw_SingleCircle (b4xloadingindicator) ","b4xloadingindicator",28,__ref.getField(false, "ba"),__ref,92);
...
try {
		Debug.PushSubsStack("Draw_ThreeCircles1 (b4xloadingindicator) ","b4xloadingindicator",28,__ref.getField(false, "ba"),__ref,73);
...
try {
		Debug.PushSubsStack("Draw_ThreeCircles2 (b4xloadingindicator) ","b4xloadingindicator",28,__ref.getField(false, "ba"),__ref,83);
...
try {
		Debug.PushSubsStack("Hide (b4xloadingindicator) ","b4xloadingindicator",28,__ref.getField(false, "ba"),__ref,68);
...
try {
		Debug.PushSubsStack("Initialize (b4xloadingindicator) ","b4xloadingindicator",28,__ref.getField(false, "ba"),__ref,20);
...
try {
		Debug.PushSubsStack("MainLoop (b4xloadingindicator) ","b4xloadingindicator",28,__ref.getField(false, "ba"),__ref,49);
...
public ResumableSub_MainLoop(b4a.example.b4xloadingindicator parent,RemoteObject __ref) {
this.parent = parent;
this.__ref = __ref;
}
...
try {
		Debug.PushSubsStack("SetAlpha (b4xloadingindicator) ","b4xloadingindicator",28,__ref.getField(false, "ba"),__ref,98);
...
try {
		Debug.PushSubsStack("SetStyle (b4xloadingindicator) ","b4xloadingindicator",28,__ref.getField(false, "ba"),__ref,44);
...
try {
		Debug.PushSubsStack("Show (b4xloadingindicator) ","b4xloadingindicator",28,__ref.getField(false, "ba"),__ref,63);
