...
public static RemoteObject _loadingindicator = RemoteObject.declareNull("b4a.example.b4xloadingindicator");
public static RemoteObject _label1 = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
public static RemoteObject _mdialog = RemoteObject.declareNull("b4a.example.b4xdialog");
