...
b4xbytesbuilder.__c.runVoidMethod ("LogImpl","93670018",RemoteObject.createImmutable("Index too large"),0);};
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_index,BA.numberCast(double.class, __ref.getField(true,"_mlength" /*RemoteObject*/ )))) { 
b4xbytesbuilder.__c.runVoidMethod ("LogImpl","93735554",RemoteObject.createImmutable("Index too large"),0);};
