...
public b4a.example.b4xbytesbuilder  _append(byte[] _data) throws Exception{
...
public b4a.example.b4xbytesbuilder  _append2(byte[] _data,int _startindex,int _length) throws Exception{
int _oldlength = 0;
