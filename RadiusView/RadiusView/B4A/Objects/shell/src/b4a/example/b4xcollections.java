...
public static RemoteObject _memptymap = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
...
public static b4a.example.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"B4XPages",Debug.moduleToString(b4a.example.b4xpages.class),"DateUtils",b4xcollections.mostCurrent._dateutils,"Main",Debug.moduleToString(b4a.example.main.class),"mEmptyList",b4xcollections._memptylist,"mEmptyMap",b4xcollections._memptymap,"Starter",Debug.moduleToString(b4a.example.starter.class),"XUIViewsUtils",Debug.moduleToString(b4a.example.xuiviewsutils.class)};
}
}